...
document.addEventListener("click", (e)=>{
    ...
    const borderWidth = parseInt(wallStyle.borderLeftWidth) + parseInt(wallStyle.borderRightWidth);
    ...
    if (newLeft < borderWidth) newLeft = borderWidth;
    else if (newLeft > wallProp.width - spiderWidth - borderWidth) newLeft = wallProp.width - spiderWidth - borderWidth;
    if (newTop < borderWidth) newTop = borderWidth;
    else if (newTop > wallProp.height - spiderHeight - borderWidth) newTop = wallProp.height - spiderHeight - borderWidth;
